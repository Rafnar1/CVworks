...
class TrainEigenFaces:
    def __init__(self):
        ...
        if not os.path.isdir(self.path):
            os.mkdir(self.path)
        self.model = cv2.face.EigenFaceRecognizer.create()
    ...
    def eigen_train_data(self):
        ...
        xml_file_path = os.path.join(script_dir, 'eigen_trained_data.xml')
        
        self.model.save(xml_file_path)
        print("Training completed successfully. Model saved to:", xml_file_path)
        return
